...
export default function NewCalendar() {
    ...
    const handleAddEvent = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://titan-server-nine.vercel.app/add-event', event, {
    ...
    const handleEventDrop = async (info) => {
        ...
        try {
            ...
            await axios.put('https://titan-server-nine.vercel.app/update-event', updatedEvent, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleUpdateEvent = async (e) => {
        ...
        try {
            ...
            await axios.put(`https://titan-server-nine.vercel.app/edit-event/${selectedEvent.id}`, updatedEvent, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleRemoveReminder = async () => {
        ...
        try {
            ...
            await axios.delete(`https://titan-server-nine.vercel.app/remove-reminder`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                params: {
